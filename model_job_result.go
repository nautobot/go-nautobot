...
type JobResult struct {
	...
	TaskArgs map[string]interface{} `json:"task_args,omitempty"`
	TaskKwargs map[string]interface{} `json:"task_kwargs,omitempty"`
	CeleryKwargs map[string]interface{} `json:"celery_kwargs,omitempty"`
...
// GetTaskArgs returns the TaskArgs field value if set, zero value otherwise.
...
// SetTaskArgs gets a reference to the given map[string]interface{} and assigns it to the TaskArgs field.
func (o *JobResult) SetTaskArgs(v map[string]interface{}) {
	o.TaskArgs = v
}

// GetTaskKwargs returns the TaskKwargs field value if set, zero value otherwise.
...
// SetTaskKwargs gets a reference to the given map[string]interface{} and assigns it to the TaskKwargs field.
func (o *JobResult) SetTaskKwargs(v map[string]interface{}) {
	o.TaskKwargs = v
}

// GetCeleryKwargs returns the CeleryKwargs field value if set, zero value otherwise.
...
// SetCeleryKwargs gets a reference to the given map[string]interface{} and assigns it to the CeleryKwargs field.
...
func (o JobResult) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.TaskKwargs) {
		toSerialize["task_kwargs"] = o.TaskKwargs
	}
	if !IsNil(o.CeleryKwargs) {
