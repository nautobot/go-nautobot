...
func (a *TenancyAPIService) TenancyTenantGroupsListExecute(r ApiTenancyTenantGroupsListRequest) (*PaginatedTenantGroupList, *http.Response, error) {
	...
	if r.hasTenants != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "has_tenants", r.hasTenants, "")
	}
	if r.id != nil {
		t := *r.id
		if reflect.TypeOf(t).Kind() == reflect.Slice {
	...
	if r.tenants != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "tenants", s.Index(i).Interface(), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "tenants", t, "multi")
		}
	}
	if r.tenantsIsnull != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "tenants__isnull", r.tenantsIsnull, "")
	}
	if r.tenantsN != nil {
		t := *r.tenantsN
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "tenants__n", s.Index(i).Interface(), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "tenants__n", t, "multi")
		}
	}
	if r.depth != nil {
...
func (a *TenancyAPIService) TenancyTenantsListExecute(r ApiTenancyTenantsListRequest) (*PaginatedTenantList, *http.Response, error) {
	...
	if r.hasLocations != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "has_locations", r.hasLocations, "")
	}
	...
	if r.hasRouteTargets != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "has_route_targets", r.hasRouteTargets, "")
	}
	...
	if r.hasVrfs != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "has_vrfs", r.hasVrfs, "")
	}
	if r.id != nil {
		t := *r.id
		if reflect.TypeOf(t).Kind() == reflect.Slice {
	...
	if r.ipAddressesIsnull != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "ip_addresses__isnull", r.ipAddressesIsnull, "")
	}
	if r.ipAddressesN != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "ip_addresses__n", s.Index(i).Interface(), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "ip_addresses__n", t, "multi")
		}
	}
	if r.lastUpdated != nil {
		t := *r.lastUpdated
	...
	if r.locationsIsnull != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "locations__isnull", r.locationsIsnull, "")
	}
	if r.locationsN != nil {
		t := *r.locationsN
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "locations__n", s.Index(i).Interface(), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "locations__n", t, "multi")
		}
	}
	if r.name != nil {
		t := *r.name
	...
	if r.routeTargets != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "route_targets", s.Index(i).Interface(), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "route_targets", t, "multi")
		}
	}
	if r.routeTargetsIsnull != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "route_targets__isnull", r.routeTargetsIsnull, "")
	}
	if r.routeTargetsN != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "route_targets__n", s.Index(i).Interface(), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "route_targets__n", t, "multi")
		}
	}
	if r.sort != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "sort", r.sort, "")
	...
	if r.vrfs != nil {
		...
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "vrfs", s.Index(i).Interface(), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "vrfs", t, "multi")
		}
	}
	if r.vrfsIsnull != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "vrfs__isnull", r.vrfsIsnull, "")
	}
	if r.vrfsN != nil {
		t := *r.vrfsN
		if reflect.TypeOf(t).Kind() == reflect.Slice {
			s := reflect.ValueOf(t)
			for i := 0; i < s.Len(); i++ {
				parameterAddToHeaderOrQuery(localVarQueryParams, "vrfs__n", s.Index(i).Interface(), "multi")
			}
		} else {
			parameterAddToHeaderOrQuery(localVarQueryParams, "vrfs__n", t, "multi")
		}
	}
	if r.depth != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "depth", r.depth, "")
