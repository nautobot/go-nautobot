...
`func NewContactAssociationRequest(associatedObjectType string, associatedObjectId string, status BulkWritableCableRequestStatus, ) *ContactAssociationRequest`
...
`func (o *ContactAssociationRequest) HasRole() bool`
