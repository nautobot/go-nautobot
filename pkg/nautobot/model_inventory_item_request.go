...
// InventoryItemRequest Base class to use for serializers based on OrganizationalModel or PrimaryModel.  Can also be used for models derived from BaseModel, so long as they support custom fields, notes, and relationships.
type InventoryItemRequest struct {
	...
	SoftwareVersion NullableTheSoftwareVersionInstalledOnThisInventoryItem `json:"software_version,omitempty"`
...
func (o *InventoryItemRequest) GetSoftwareVersion() TheSoftwareVersionInstalledOnThisInventoryItem {
	if o == nil || IsNil(o.SoftwareVersion.Get()) {
		var ret TheSoftwareVersionInstalledOnThisInventoryItem
		return ret
	}
...
// SetSoftwareVersion gets a reference to the given NullableTheSoftwareVersionInstalledOnThisInventoryItem and assigns it to the SoftwareVersion field.
