...
type WritableDeviceTypeRequest struct {
	FrontImage Nullable*os.File `json:"front_image,omitempty"`
	RearImage Nullable*os.File `json:"rear_image,omitempty"`
...
// SetFrontImage gets a reference to the given Nullable*os.File and assigns it to the FrontImage field.
...
func (o *WritableDeviceTypeRequest) SetFrontImageNil() {
...
// SetRearImage gets a reference to the given Nullable*os.File and assigns it to the RearImage field.
...
func (o *WritableDeviceTypeRequest) SetRearImageNil() {
	o.RearImage.Set(nil)
}
