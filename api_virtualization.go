...
type ApiVirtualizationInterfacesListRequest struct {
	...
	macAddressRe *[]string
	mode *[]DcimInterfacesListModeParameterInner
	modeIc *[]string
	modeIe *[]string
	modeIew *[]string
	modeIre *[]string
...
func (r ApiVirtualizationInterfacesListRequest) Mode(mode []DcimInterfacesListModeParameterInner) ApiVirtualizationInterfacesListRequest {
	r.mode = &mode
	return r
}
