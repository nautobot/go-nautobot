...
type PatchedWritableRackRequest struct {
	...
	Type_ *OneOfPatchedWritableRackRequestType_ `json:"type,omitempty"`
	// Rail-to-rail width
	Width *AllOfPatchedWritableRackRequestWidth `json:"width,omitempty"`
	...
	OuterUnit *OneOfPatchedWritableRackRequestOuterUnit `json:"outer_unit,omitempty"`
