...
type ControllerManagedDeviceGroup struct {
	...
	RadioProfiles []BulkWritableCableRequestStatus `json:"radio_profiles"`
	WirelessNetworks []BulkWritableCableRequestStatus `json:"wireless_networks"`
...
func NewControllerManagedDeviceGroup(objectType string, display string, url string, naturalSlug string, name string, controller BulkWritableControllerManagedDeviceGroupRequestController, radioProfiles []BulkWritableCableRequestStatus, wirelessNetworks []BulkWritableCableRequestStatus, created NullableTime, lastUpdated NullableTime, notesUrl string) *ControllerManagedDeviceGroup {
	...
	this.RadioProfiles = radioProfiles
...
// GetRadioProfiles returns the RadioProfiles field value
func (o *ControllerManagedDeviceGroup) GetRadioProfiles() []BulkWritableCableRequestStatus {
	...
	return o.RadioProfiles
}

// GetRadioProfilesOk returns a tuple with the RadioProfiles field value
// and a boolean to check if the value has been set.
func (o *ControllerManagedDeviceGroup) GetRadioProfilesOk() ([]BulkWritableCableRequestStatus, bool) {
	if o == nil {
		return nil, false
	}
	return o.RadioProfiles, true
}

// SetRadioProfiles sets field value
...
func (o ControllerManagedDeviceGroup) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["radio_profiles"] = o.RadioProfiles
...
func (o *ControllerManagedDeviceGroup) UnmarshalJSON(data []byte) (err error) {
	...
	*o = ControllerManagedDeviceGroup(varControllerManagedDeviceGroup)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "radio_profiles")
		delete(additionalProperties, "wireless_networks")
