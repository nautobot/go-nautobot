...
type Job struct {
	...
	JobQueues []JobQueues `json:"job_queues"`
...
// GetJobQueues returns the JobQueues field value
...
// GetJobQueuesOk returns a tuple with the JobQueues field value
// and a boolean to check if the value has been set.
func (o *Job) GetJobQueuesOk() ([]JobQueues, bool) {
	if o == nil {
		return nil, false
	}
	return o.JobQueues, true
}

// SetJobQueues sets field value
...
func (o Job) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["job_queues"] = o.JobQueues
...
func (o *Job) UnmarshalJSON(data []byte) (err error) {
	...
	*o = Job(varJob)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "job_queues")
