...
type InterfaceMode struct {
	Value *DcimInterfacesListModeParameterInner `json:"value,omitempty"`
...
func (o *InterfaceMode) GetValue() DcimInterfacesListModeParameterInner {
	if o == nil || IsNil(o.Value) {
		var ret DcimInterfacesListModeParameterInner
		return ret
	}
	return *o.Value
}
...
// SetValue gets a reference to the given DcimInterfacesListModeParameterInner and assigns it to the Value field.
