...
type DeviceRedundancyGroupFailoverStrategy struct {
	Value *DcimDeviceRedundancyGroupsListFailoverStrategyParameterInner `json:"value,omitempty"`
...
func (o *DeviceRedundancyGroupFailoverStrategy) GetValue() DcimDeviceRedundancyGroupsListFailoverStrategyParameterInner {
	if o == nil || IsNil(o.Value) {
		var ret DcimDeviceRedundancyGroupsListFailoverStrategyParameterInner
		return ret
	}
	return *o.Value
}
...
// SetValue gets a reference to the given DcimDeviceRedundancyGroupsListFailoverStrategyParameterInner and assigns it to the Value field.
