...
type VRF struct {
	...
	VirtualDeviceContexts []BulkWritableCableRequestStatus `json:"virtual_device_contexts"`
...
func NewVRF(objectType string, display string, url string, naturalSlug string, name string, devices []BulkWritableCableRequestStatus, virtualMachines []BulkWritableCableRequestStatus, virtualDeviceContexts []BulkWritableCableRequestStatus, prefixes []BulkWritableCableRequestStatus, created NullableTime, lastUpdated NullableTime, notesUrl string) *VRF {
	...
	this.VirtualDeviceContexts = virtualDeviceContexts
...
// GetVirtualDeviceContexts returns the VirtualDeviceContexts field value
func (o *VRF) GetVirtualDeviceContexts() []BulkWritableCableRequestStatus {
	...
	return o.VirtualDeviceContexts
}

// GetVirtualDeviceContextsOk returns a tuple with the VirtualDeviceContexts field value
// and a boolean to check if the value has been set.
func (o *VRF) GetVirtualDeviceContextsOk() ([]BulkWritableCableRequestStatus, bool) {
	if o == nil {
		return nil, false
	}
	return o.VirtualDeviceContexts, true
}

// SetVirtualDeviceContexts sets field value
func (o *VRF) SetVirtualDeviceContexts(v []BulkWritableCableRequestStatus) {
	o.VirtualDeviceContexts = v
}
...
func (o VRF) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["virtual_device_contexts"] = o.VirtualDeviceContexts
...
func (o *VRF) UnmarshalJSON(data []byte) (err error) {
	...
	*o = VRF(varVRF)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "virtual_device_contexts")
