...
type PowerOutletFeedLeg struct {
	Value *DcimPowerOutletTemplatesListFeedLegParameterInner `json:"value,omitempty"`
	Label *DcimPowerOutletTemplatesListFeedLegParameterInner `json:"label,omitempty"`
...
func (o *PowerOutletFeedLeg) GetValue() DcimPowerOutletTemplatesListFeedLegParameterInner {
	if o == nil || IsNil(o.Value) {
		var ret DcimPowerOutletTemplatesListFeedLegParameterInner
		return ret
	}
	return *o.Value
}
...
// SetValue gets a reference to the given DcimPowerOutletTemplatesListFeedLegParameterInner and assigns it to the Value field.
...
// SetLabel gets a reference to the given DcimPowerOutletTemplatesListFeedLegParameterInner and assigns it to the Label field.
