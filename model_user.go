...
type User struct {
	...
	DefaultSavedViews []UserSpecificDefaultSavedViews `json:"default_saved_views"`
...
func NewUser(id string, objectType string, display string, url string, naturalSlug string, username string, defaultSavedViews []UserSpecificDefaultSavedViews) *User {
	...
	this.DefaultSavedViews = defaultSavedViews
	return &this
}
...
// GetDefaultSavedViews returns the DefaultSavedViews field value
func (o *User) GetDefaultSavedViews() []UserSpecificDefaultSavedViews {
	if o == nil {
		var ret []UserSpecificDefaultSavedViews
		return ret
	}

	return o.DefaultSavedViews
}

// GetDefaultSavedViewsOk returns a tuple with the DefaultSavedViews field value
// and a boolean to check if the value has been set.
func (o *User) GetDefaultSavedViewsOk() ([]UserSpecificDefaultSavedViews, bool) {
	if o == nil {
		return nil, false
	}
	return o.DefaultSavedViews, true
}

// SetDefaultSavedViews sets field value
func (o *User) SetDefaultSavedViews(v []UserSpecificDefaultSavedViews) {
	o.DefaultSavedViews = v
}
...
func (o User) ToMap() (map[string]interface{}, error) {
	...
	toSerialize["default_saved_views"] = o.DefaultSavedViews
...
func (o *User) UnmarshalJSON(data []byte) (err error) {
	...
	*o = User(varUser)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "default_saved_views")
