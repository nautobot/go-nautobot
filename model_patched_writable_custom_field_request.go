...
type PatchedWritableCustomFieldRequest struct {
	...
	Type_ *AllOfPatchedWritableCustomFieldRequestType_ `json:"type,omitempty"`
	...
	FilterLogic *AllOfPatchedWritableCustomFieldRequestFilterLogic `json:"filter_logic,omitempty"`
