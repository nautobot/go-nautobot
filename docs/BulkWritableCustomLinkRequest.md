...
**ButtonClass** | [***AllOfBulkWritableCustomLinkRequestButtonClass**](AllOfBulkWritableCustomLinkRequestButtonClass.md) | The class of the first link in a group will be used for the dropdown button | [optional] [default to null]
