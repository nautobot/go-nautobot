...
`func NewWritablePowerOutletTemplateRequest(name string, deviceType BulkWritableCableRequestStatus, ) *WritablePowerOutletTemplateRequest`
...
`func (o *WritablePowerOutletTemplateRequest) GetDeviceType() BulkWritableCableRequestStatus`

GetDeviceType returns the DeviceType field if non-nil, zero value otherwise.

### GetDeviceTypeOk

`func (o *WritablePowerOutletTemplateRequest) GetDeviceTypeOk() (*BulkWritableCableRequestStatus, bool)`
...
`func (o *WritablePowerOutletTemplateRequest) SetDeviceType(v BulkWritableCableRequestStatus)`
