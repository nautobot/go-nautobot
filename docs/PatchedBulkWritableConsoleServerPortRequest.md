...
`func (o *PatchedBulkWritableConsoleServerPortRequest) GetDevice() BulkWritableCableRequestStatus`

GetDevice returns the Device field if non-nil, zero value otherwise.

### GetDeviceOk

`func (o *PatchedBulkWritableConsoleServerPortRequest) GetDeviceOk() (*BulkWritableCableRequestStatus, bool)`
...
`func (o *PatchedBulkWritableConsoleServerPortRequest) SetDevice(v BulkWritableCableRequestStatus)`
