...
`func (o *CableTermination) GetId() string`

GetId returns the Id field if non-nil, zero value otherwise.

### GetIdOk

`func (o *CableTermination) GetIdOk() (*string, bool)`
...
`func (o *CableTermination) SetId(v string)`
...
`func (o *CableTermination) GetObjectType() string`

GetObjectType returns the ObjectType field if non-nil, zero value otherwise.

### GetObjectTypeOk

`func (o *CableTermination) GetObjectTypeOk() (*string, bool)`
...
`func (o *CableTermination) SetObjectType(v string)`
