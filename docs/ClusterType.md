...
`func NewClusterType(id string, objectType string, display string, url string, naturalSlug string, clusterCount int32, name string, created NullableTime, lastUpdated NullableTime, notesUrl string, ) *ClusterType`
