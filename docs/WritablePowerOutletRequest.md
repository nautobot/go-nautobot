...
**Type_** | [***OneOfWritablePowerOutletRequestType_**](OneOfWritablePowerOutletRequestType_.md) | Physical port type | [optional] [default to null]
**FeedLeg** | [***OneOfWritablePowerOutletRequestFeedLeg**](OneOfWritablePowerOutletRequestFeedLeg.md) | Phase (for three-phase feeds) | [optional] [default to null]
