...
type BulkWritableVRFDeviceAssignmentRequest struct {
	...
	VirtualDeviceContext NullableBulkWritableCircuitRequestTenant `json:"virtual_device_context,omitempty"`
...
// SetVirtualDeviceContext gets a reference to the given NullableBulkWritableCircuitRequestTenant and assigns it to the VirtualDeviceContext field.
