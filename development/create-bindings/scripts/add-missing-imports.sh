...
files=("api_circuits.go" "api_cloud.go" "api_data_validation.go" "api_dcim.go" "api_extras.go" "api_ipam.go" "api_load_balancers.go" "api_tenancy.go" "api_users.go" "api_virtualization.go" "api_vpn.go" "api_wireless.go")
