...
type WritableDeviceRequest struct {
	LocalConfigContextData map[string]interface{} `json:"local_config_context_data,omitempty"`
...
// SetLocalConfigContextData gets a reference to the given map[string]interface{} and assigns it to the LocalConfigContextData field.
