...
type PowerPort struct {
	...
	CablePeer *AllOfPowerPortCablePeer `json:"cable_peer"`
	ConnectedEndpointType string `json:"connected_endpoint_type"`
	ConnectedEndpoint *AllOfPowerPortConnectedEndpoint `json:"connected_endpoint"`
	ConnectedEndpointReachable bool `json:"connected_endpoint_reachable"`
	Type_ *PowerPortType `json:"type,omitempty"`
