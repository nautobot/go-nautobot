...
/*
SwaggerYamlApiService
OpenApi3 schema for this API. Format can be selected via content negotiation.  - YAML: application/vnd.oai.openapi - JSON: application/vnd.oai.openapi+json
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *SwaggerYamlApiSwaggerYamlRetrieveOpts - Optional Parameters:
     * @param "Lang" (optional.String) - 
     * @param "Depth" (optional.Int32) -  Serializer Depth
@return map[string]Object
*/

type SwaggerYamlApiSwaggerYamlRetrieveOpts struct {
    Lang optional.String
    Depth optional.Int32
}

func (a *SwaggerYamlApiService) SwaggerYamlRetrieve(ctx context.Context, localVarOptionals *SwaggerYamlApiSwaggerYamlRetrieveOpts) (map[string]Object, *http.Response, error) {
	var (
