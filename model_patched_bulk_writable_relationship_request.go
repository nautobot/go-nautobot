...
type PatchedBulkWritableRelationshipRequest struct {
	...
	Type_ *AllOfPatchedBulkWritableRelationshipRequestType_ `json:"type,omitempty"`
	// Objects on the specified side MUST implement this relationship. Not permitted for symmetric relationships.
	RequiredOn *OneOfPatchedBulkWritableRelationshipRequestRequiredOn `json:"required_on,omitempty"`
