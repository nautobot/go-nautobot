...
type PatchedWritablePowerOutletTemplateRequest struct {
	...
	Type_ *OneOfPatchedWritablePowerOutletTemplateRequestType_ `json:"type,omitempty"`
	// Phase (for three-phase feeds)
	FeedLeg *OneOfPatchedWritablePowerOutletTemplateRequestFeedLeg `json:"feed_leg,omitempty"`
